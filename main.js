		...
		function () {
			...
			if (_v0.$ === 'Ok') {
				...
				return {
					...
					isMonochrome: false,
					numberOfSteps: 0,
					settings: A5($author$project$Settings$Settings, 10, 10, 0, '', false),
					table: $author$project$Main$emptyTable,
	...
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				var width = msg.a;
				var height = msg.b;
				var newWindowSize = {height: height, width: width};
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var $author$project$Main$edges = {bottom: 30, left: 30, right: 30, top: 30};
	...
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Background$color(
					$author$project$Main$colorToRGB(cell.color)),
					$mdgriffith$elm_ui$Element$height(
