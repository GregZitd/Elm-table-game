...
var $author$project$Main$GenerateSeedAndTable = function (a) {
	return {$: 'GenerateSeedAndTable', a: a};
};
...
var $author$project$Main$Settings = F4(
	function (setWidth, setHeight, seed, seedInput) {
		return {seed: seed, seedInput: seedInput, setHeight: setHeight, setWidth: setWidth};
	});
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		A4(
			...
			A4($author$project$Main$Settings, 10, 10, 0, ''),
...
var $author$project$Main$genColor = A2(
	...
	_List_fromArray(
		[$author$project$Main$Blue, $author$project$Main$Green, $author$project$Main$Yellow, $author$project$Main$Purple]));
var $author$project$Main$genCell = F2(
	function (rowNum, colNum) {
		var mkCell = function (colorArg) {
			return {
				color: colorArg,
				index: {col: colNum, row: rowNum}
			};
		};
...
var $author$project$Main$viewChangeColorBar = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
...
var $author$project$Main$viewCurrentPosition = function (ind) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				$elm$html$Html$text(
				'The currently selected field is: ' + ($elm$core$String$fromInt(ind.row) + (', ' + $elm$core$String$fromInt(ind.col))))
			]));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$GenerateRandomSeed)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Generate random puzzle')
							])),
						$elm$html$Html$text(
						'Current seed is: ' + $elm$core$String$fromInt(settings.seed))
					])),
				A2(
				$elm$html$Html$input,
				_List_fromArray(
					[
						...
						A2($elm$core$Basics$composeL, $author$project$Main$UpdateSettings, $author$project$Main$UpdateSeed))
					]),
				_List_Nil),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Main$GenerateTableFromSeed)
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('Generate puzzle from seed')
					]))
			]));
};
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Main$viewCurrentPosition(model.currentSelection),
				$author$project$Main$viewChangeColorBar,
				$author$project$Main$viewTable(model.table),
				$elm$html$Html$text(
				'Current number of steps: ' + $elm$core$String$fromInt(model.numberOfSteps)),
				$author$project$Main$viewSettings(model.settings)
			]));
};
